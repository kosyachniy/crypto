...
with db:
	db.execute("CREATE TABLE currencies (id INTEGER PRIMARY KEY AUTOINCREMENT, currency int, changer int, count real, price real, loss real, half real, full real, term int, time time, succ int)")
