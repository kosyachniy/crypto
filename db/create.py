...
with db:
	...
	db.execute("CREATE TABLE operations (id INTEGER PRIMARY KEY AUTOINCREMENT, act int, currency int, changer int, buy int, per real, count real, price real, meschat int, mesid int, time1 time, time2 time)")
